...
var _toPlainObject = require('./toPlainObject');
    ...
    return function (createStore) {
      return function (reducer, initialState) {
        ...
        history.listen(function (error, nextRouterState) {
          ...
          var prevRouterState = routerStateSelector(_toPlainObject2['default'](store.getState()));
        ...
        store.subscribe(function () {
          var nextRouterState = routerStateSelector(_toPlainObject2['default'](store.getState()));
